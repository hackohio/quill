            ...
            <Container className="dashboard-window-information">
              ...
              (submitted && !confirmed && confirmationDeadline > today) ? (
                <Container>
                  ...
                  <br />
                  <strong>
                    You can {confirmed ? 'Edit ' : 'Submit '} your confirmation
                    information until
                    {confirmationDeadline.toString()}, after which you will only
                    be able to view your confirmation information. You will have
                ...
                <Container>
                  ...
                  <strong>
                    ...
                    until {applicationDeadline.toString()}, after which you will
                    only be able to view your application information.{' '}
                    {submitted
                      ? `Now that you
                ...
                <Container>
                  ...
                  <strong>
                    ...
                    you do not see one, check your spam and/or click the resend
                    email button.
                  </strong>
                  <Divider />
                  <Button circular color="blue">
