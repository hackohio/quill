...
import MajorSelector from '../Application/MajorSelector';
import SchoolSelector from '../Application/SchoolSelector';

export default function UserModal(selectedUser: User) {
  ...
  useEffect(() => {
    if (selectedUser != null) {
      ...
      if (name == '' && selectedUser.profile.name != '') {
        setName(selectedUser.profile.name);
      }
      if (school == '' && selectedUser.profile.school != '') {
        setSchool(selectedUser.profile.school);
      }
      if (major == '' && selectedUser.profile.major != '') {
        setMajor(selectedUser.profile.major);
      }
      if (gradYear == '' && selectedUser.profile.graduationYear != '') {
        setGradYear(selectedUser.profile.graduationYear);
      }
      if (gradMonth == '' && selectedUser.profile.graduationMonth != '') {
        setGradMonth(selectedUser.profile.graduationMonth);
      }
      if (degree == '' && selectedUser.profile.degree != '') {
        setDegree(selectedUser.profile.degree);
      }
      if (gender == '' && selectedUser.profile.gender != '') {
        setGender(selectedUser.profile.gender);
      }
      if (ethnicity == '' && selectedUser.profile.ethnicity != '') {
        setEthnicity(selectedUser.profile.ethnicity);
      }
      if (description == '' && selectedUser.profile.description != '') {
        setDescription(selectedUser.profile.description);
      }
      if (essay == '' && selectedUser.profile.essay != '') {
        setEssay(selectedUser.profile.essay);
      }
      if (adult == false && selectedUser.profile.adult === true) {
        setAdult(true);
      }
    }
  }, [selectedUser]);
