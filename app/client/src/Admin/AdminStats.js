            ...
            <Segment>
              ...
              <List className="stats-list">
                ...
                <List.Item>
                  <List.Icon name="child" />
                  <List.Content>
                    <strong>Women's shirt sizes</strong> : XS (
                    {stats.shirtSizes['WXS']}) S ({stats.shirtSizes['WS']}) M (
                    {stats.shirtSizes['WM']}) L ({stats.shirtSizes['WL']}) XL (
                    {stats.shirtSizes['WXL']}) XXL ({stats.shirtSizes['WXXL']})
                  </List.Content>
                </List.Item>
                <Divider />
                <List.Item>
                  <List.Icon name="plug" />
                  <List.Content>
                    <strong>Needs/Wants Hardware</strong> :{stats.wantsHardware}
                  </List.Content>
                </List.Item>
                <Divider />
                <List.Item>
            ...
            <Segment>
              ...
              <List>
                ...
                <List.Item>
                  ...
                  <List.Content>
                    ...
                    :(
                    {((stats.demo.gender['F'] / stats.demoSummary.count) *
                      100) |
                      0}
                    %)
                  </List.Content>
                ...
                <List.Item>
                  ...
                  <List.Content>
                    ...
                    :(
                    {((stats.demo.gender['M'] / stats.demoSummary.count) *
                      100) |
                      0}
                    %)
                  </List.Content>
                ...
                <List.Item>
                  ...
                  <List.Content>
                    ...
                    :(
                    {((stats.demo.gender['B'] / stats.demoSummary.count) *
                      100) |
                      0}
                    %)
                  </List.Content>
                ...
                <List.Item>
                  ...
                  <List.Content>
                    ...
                    :(
                    {((stats.demo.gender['O'] / stats.demoSummary.count) *
                      100) |
                      0}
                    %)
                  </List.Content>
                ...
                <List.Item>
                  ...
                  <List.Content>
                    <strong>Did Not Respond {stats.demo.gender['N']}</strong>
                    :(
                    {((stats.demo.gender['N'] / stats.demoSummary.count) *
                      100) |
                      0}
                    %)
                  </List.Content>
              ...
              <List>
                <List.Item>
                  ...
                  {((stats.demo.year['2025'] / stats.demoSummary.count) * 100) |
                    0}
                  %)
                </List.Item>
                ...
                <List.Item>
                  ...
                  {((stats.demo.year['2024'] / stats.demoSummary.count) * 100) |
                    0}
                  %)
                </List.Item>
                ...
                <List.Item>
                  ...
                  {((stats.demo.year['2023'] / stats.demoSummary.count) * 100) |
                    0}
                  %)
                </List.Item>
                ...
                <List.Item>
                  ...
                  {((stats.demo.year['2022'] / stats.demoSummary.count) * 100) |
                    0}
                  %)
                </List.Item>
                <List.Item>
              ...
              <List>
                ...
                <List.Item>
                  ...
                  {((stats.demo.degree['Bachelors'] / stats.demoSummary.count) *
                    100) |
                    0}
                  %)
                </List.Item>
                <List.Item>
                  ...
                  {((stats.demo.degree['Masters'] / stats.demoSummary.count) *
                    100) |
                    0}
                  %)
                </List.Item>
                <List.Item>
                  ...
                  {((stats.demo.degree['Doctorate'] / stats.demoSummary.count) *
                    100) |
                    0}
                  %)
                </List.Item>
              ...
              <List>
                <List.Item>
                  <List.Content>
                    {stats.demo.schools.forEach(school => {
                      <div>
                        <strong>{school.email}</strong>: {school.count}(
                        {((school.count / stats.demoSummary.count) * 100) | 0}%)
                        <p>
