...
angular.module('reg')
  ...
  .run($transitions => {
    $transitions.onStart({}, transition => {
      ...
      const requireLogin = transition.to().data.requireLogin;
      const requireAdmin = transition.to().data.requireAdmin;
      const requireVerified = transition.to().data.requireVerified;
      const requireAdmitted = transition.to().data.requireAdmitted;
