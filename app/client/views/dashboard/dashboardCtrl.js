...
angular.module('reg')
  .controller('DashboardCtrl', [
    ...
    function ($rootScope, $scope, $sce, currentUser, settings, Utils, AuthService, UserService, EVENT_INFO, DASHBOARD) {
      ...
      $scope.timeConfirm = Utils.formatTime(currentUser.status.confirmBy);
      ...
      for (let msg in $scope.DASHBOARD) {
        ...
        if ($scope.DASHBOARD[msg].includes('[CONFIRM_DEADLINE]')) {
          $scope.DASHBOARD[msg] = $scope.DASHBOARD[msg].replace('[CONFIRM_DEADLINE]', "October 20th at 7:00PM");
        }
      }
